...
\author{Carlos}
\institute{Econ 33550 --- Spatial Economics}
\date{\today}
...
\begin{frame}{Global Shipping Density (Log Scale)}
  \centering
  \includegraphics[width=0.92\textwidth]{../Figures/generated/global_quicklook.png}
  \vspace{2pt}
...
\begin{frame}{Chokepoint Definitions: Bounding Box Approach}
  \begin{columns}[T]
    ...
    \begin{column}{0.52\textwidth}
      \centering
      \includegraphics[width=\textwidth]{../Figures/generated/bounding_box_example.png}
...
\begin{frame}{Chokepoint Traffic Intensity}
  \centering
  \includegraphics[width=0.85\textwidth]{../Figures/generated/chokepoint_ranking.png}
  \vspace{2pt}
...
\begin{frame}{AIS Density Detail: Suez Canal}
  \centering
  \includegraphics[width=0.65\textwidth]{../Figures/generated/suez_intensity_detail.png}
  \vspace{2pt}
...
\begin{frame}{Suez Canal: Descriptive Statistics}
  \centering
  \includegraphics[width=0.82\textwidth]{../Figures/generated/suez_density_stats.png}
\end{frame}
...
\begin{frame}{Methods: Edge Cost Specification}
  \begin{columns}[T]
    ...
    \begin{column}{0.52\textwidth}
      \centering
      \includegraphics[width=\textwidth]{../Figures/generated/edge_cost_diagram.png}
...
\begin{frame}{Methods: Security as a Cost Shifter}
  ...
  \end{equation*}
  \centering
  \includegraphics[width=0.82\textwidth]{../Figures/generated/security_shifter_comparison.png}
  \vspace{2pt}
...
\begin{frame}{Methods: Congestion Calibration from AIS}
  \centering
  \includegraphics[width=0.82\textwidth]{../Figures/generated/congestion_calibration.png}
  \vspace{2pt}
...
\begin{frame}{Methods: Route Choice Before/After}
  \centering
  \includegraphics[width=0.92\textwidth]{../Figures/generated/route_choice_before_after.png}
  \vspace{2pt}
...
\begin{frame}{Methods: Three Scenario Types}
  ...
  \vspace{4pt}
  \centering
  \includegraphics[width=0.82\textwidth]{../Figures/generated/suez_scenario_3panel.png}
...
\begin{frame}{Results: Full Closure --- Visual Summary}
  \centering
  \includegraphics[width=0.92\textwidth]{../Figures/generated/scenario_summary.png}
  \vspace{2pt}
...
\begin{frame}{Results: Suez Canal Closure}
  \centering
  \includegraphics[width=0.82\textwidth]{../Figures/generated/scenario_example.png}
  \vspace{2pt}
...
\begin{frame}{Results: Port Vulnerability Under Closure}
  \centering
  \includegraphics[width=0.92\textwidth]{../Figures/generated/closure_impact_map.png}
  \vspace{2pt}
...
\begin{frame}{Results: Partial Degradation Surface}
  \centering
  \includegraphics[width=0.78\textwidth]{../Figures/generated/partial_degradation_surface.png}
  \vspace{2pt}
...
\begin{frame}{Results: Port Vulnerability Matrix}
  \centering
  \includegraphics[width=0.65\textwidth]{../Figures/generated/port_vulnerability_heatmap.png}
  \vspace{2pt}
...
\begin{frame}{Results: Per-Chokepoint Security Risk}
  \centering
  \includegraphics[width=0.85\textwidth]{../Figures/generated/security_scenario_comparison.png}
  \vspace{2pt}
...
\begin{frame}{Structural Patterns}
  \begin{itemize}
    ...
    \item Connects to: optimal networks \citep{fajgelbaum2020optimal}, congestion \citep{hierons2024spreading}, spatial policy \citep{fajgelbaum2020spatial}
  \end{itemize}
\end{frame}
...
\begin{frame}{Appendix: All Chokepoint Bounding Boxes}
  \centering
  \includegraphics[width=0.92\textwidth]{../Figures/generated/appendix_all_bboxes_world.png}
  \vspace{2pt}
